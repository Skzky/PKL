...
<div class="register-box">
  ...
  <div class="card">
    ...
    <div class="image center text-center mt-1">
      <img src="{{ asset('template/dist/img/pemko.png') }}" class="mx-auto img-fluid" alt="User Image" width="160" height="160">
    </div>

    <div class="card-body register-card-body">
      <p class="login-box-msg">Registrasi Pengguna Baru</p>

      <form action="{{ url('Simpamregistrasi') }}" method="post">
        {{ csrf_field() }}
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block text-center">Registrasi</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
